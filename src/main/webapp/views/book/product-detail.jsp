                    ...
                    <main class="max-w-[1400px] mx-auto px-8 py-8 flex flex-col gap-8">
                        ...
                        <section class="flex flex-col lg:flex-row gap-10">
                            ...
                            <div class="flex-shrink-0 w-full lg:w-[499px] flex flex-col gap-4">
                                ...
                                <% String rawThumb=(request.getAttribute("book") !=null) ? ((model.Book)
                                    request.getAttribute("book")).getThumbnail() : "" ; if (rawThumb==null) rawThumb=""
                                    ; String[] imgArr=rawThumb.split("\\|", -1); String img1=imgArr.length> 0 ?
                                    imgArr[0].trim() : "";
                            ...
                            <div class="flex-1 min-w-0 flex flex-col gap-6">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-4 flex-wrap">
                                        <form id="add-to-cart-form" action="${pageContext.request.contextPath}/cart"
                                            method="POST" class="flex items-center gap-4 flex-wrap flex-1">
                                            <input type="hidden" name="action" value="add" />
                                            <input type="hidden" name="bookID" value="${book.bookID}" />
                                            <input type="hidden" name="redirect"
                                                value="${pageContext.request.contextPath}/products?id=${book.bookID}" />
                                            ...
                                            <c:if test="${book.status == 'available' and book.stockQuantity > 0}">
                                                <div
                                                    ...
                                                    <input id="form-qty" name="quantity" type="number" value="1" min="1"
                                            ...
                                            <c:choose>
                                                <c:when test="${book.status == 'available' and book.stockQuantity > 0}">
                                                    <c:choose>
                                                        <c:when
                                                            test="${not empty sessionScope.account and sessionScope.account.role == 'customer'}">
                                                            <button type="button" id="btn-add-to-cart"
                                                                ...
                                                                <i data-lucide="shopping-cart" class="w-5 h-5"></i> Thêm
                                                                vào giỏ
                                                            </button>
                                                        </c:when>
                                                        <c:otherwise>
                                                    ...
                                                    <form action="${pageContext.request.contextPath}/wishlist"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                                ...
                                                                stroke="#ef4444" stroke-width="2" class="w-5 h-5">
                                                                <path
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col gap-1 px-4 first:pl-0">
                                        <span class="text-[12px] font-bold text-gray-500 uppercase tracking-wide">Hình
                                            thức</span>
                                    ...
                                    <div class="flex flex-col gap-1 px-4">
                                        <span class="text-[12px] font-bold text-gray-500 uppercase tracking-wide">Xuất
                                            xứ</span>
                                        <span class="text-[16px] font-medium text-[#222222]">
                                            <c:choose>
                                    ...
                                    <div class="flex flex-col gap-1 px-4">
                                        <span class="text-[12px] font-bold text-gray-500 uppercase tracking-wide">Bộ
                                            sách</span>
                                        <span class="text-[16px] font-medium text-[#222222]">
                                            <c:choose>
                                    ...
                                    <div class="flex flex-col gap-1 px-4">
                                        <span class="text-[12px] font-bold text-gray-500 uppercase tracking-wide">Số
                                            trang</span>
                                        <span class="text-[16px] font-medium text-[#222222]">
                                            <c:choose>
                                ...
                                <c:choose>
                                        ...
                                        <div class="flex flex-col gap-6">
                                            <c:forEach items="${reviews}" var="review">
                                                <div
                                                    ...
                                                    <p class="text-gray-700 leading-relaxed text-sm">${review.comment}
                                                    </p>
                                    ...
                                    <c:otherwise>
                                        <div
                                            ...
                                            <div class="text-gray-400 mt-2">Hãy là người đầu tiên trải nghiệm và đánh
                        ...
                        <c:if test="${not empty relatedBooks}">
                            <section class="pt-2">
                                <div class="flex items-center justify-between mb-5">
                                    <h2 class="section-title-left text-[20px] font-bold text-primary">📚 Bạn cũng có thể
                                        thích</h2>
                                            ...
                                            <div class="relative block bg-[#f0f4ff] aspect-[3/4] overflow-hidden">
                                                <a href="${pageContext.request.contextPath}/products?id=${rb.bookID}">
                                                    <%-- [FIX] check đúng field đang được hiển thị (rb.thumbnailFirst)
                                                        thay vì check rb.thumbnail (chuỗi thô, có thể khác trạng thái
                                                        rỗng) --%>
                                                        <c:choose>
                                                            <c:when test="${not empty rb.thumbnailFirst}">
                                                                <img src="${rb.thumbnailFirst}" alt="${rb.title}"
