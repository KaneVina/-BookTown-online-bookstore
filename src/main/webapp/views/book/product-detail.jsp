            ...
            <div class="bg-white border border-gray-200 shadow-sm rounded-xl px-6 pt-10 pb-6 flex flex-col gap-6">
                ...
                <div class="flex items-center gap-4 flex-wrap">
                    <div class="flex items-center border-2 border-gray-200 rounded-full overflow-hidden">
                        <button id="qty-minus" class="px-4 py-2 text-lg font-bold text-gray-500 hover:bg-gray-100 transition-colors">−</button>
                        ...
                        <button id="qty-plus" class="px-4 py-2 text-lg font-bold text-gray-500 hover:bg-gray-100 transition-colors">+</button>
                    </div>

                    <c:choose>
                        <c:when test="${book.stockQuantity > 0}">
                            <button class="flex-1 bg-secondary text-primary font-bold text-[16px] py-4 rounded-full flex items-center justify-center gap-2 hover:opacity-90 transition-opacity min-w-[160px]">
                                <i data-lucide="shopping-cart" class="w-5 h-5"></i> Thêm vào giỏ
                            </button>
                            <button class="flex-1 border-2 border-primary text-primary font-bold text-[16px] py-4 rounded-full flex items-center justify-center gap-2 hover:bg-primary hover:text-white transition-all min-w-[160px]">
                                <i data-lucide="heart" class="w-5 h-5"></i> Thêm vào yêu thích
                            </button>
                        </c:when>
                        <c:otherwise>
                            <button disabled class="flex-1 bg-gray-200 text-gray-400 font-bold text-[16px] py-4 rounded-full flex items-center justify-center gap-2 cursor-not-allowed min-w-[160px]">
