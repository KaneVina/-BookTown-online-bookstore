...
<body class="text-on-background">
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12 lg:col-span-8 space-y-6" id="cart-list">
                        <c:forEach var="item" items="${cartItems}">
                            ...
                            <div class="bg-white rounded-xl p-6 flex flex-col md:flex-row items-center gap-6
                                ...
                                <div
                                    class="w-24 h-36 flex-shrink-0 overflow-hidden rounded-lg bg-[#e6f6ff]">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <div
                                                class="w-full h-full flex items-center justify-center text-[#c2c6d4]">
                                ...
                                <div class="flex-grow space-y-1">
                                    <a
                                        ...
                                        <h3
                                            class="text-xl font-bold text-[#004d99] hover:underline">
                                            ${item.title}</h3>
                                    </a>
                                    <p class="text-sm text-[#424752]">Tác giả:
                                ...
                                <div class="flex flex-col items-center md:items-end gap-4">
                                    <c:choose>
                                        <c:when test="${item.stockQuantity == 0}">
                                            <span
                                                class="text-xs font-bold text-white bg-red-500 px-3 py-1 rounded-full">Hết
                                                hàng</span>
                                            <div
                                                class="flex items-center border border-[#c2c6d4] rounded-lg overflow-hidden bg-[#f5f5f5] opacity-50">
                                                <button
                                                    class="px-3 py-1 font-bold cursor-not-allowed"
                                                    disabled>−</button>
                                                <span
                                                    class="px-4 py-1 text-base border-x border-[#c2c6d4]"
                                        ...
                                        <c:otherwise>
                                            <div
                                                class="flex items-center border border-[#c2c6d4] rounded-lg overflow-hidden bg-[#e6f6ff]">
                                                <button
                                                    class="px-3 py-1 hover:bg-[#cfe6f2] transition-colors font-bold"
                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div class="bg-white rounded-xl p-8 sticky top-24 space-y-6"
                            ...
                            <h2
                                class="text-2xl font-bold text-[#071e27] border-b border-[#c2c6d4] pb-4">
                                Tóm tắt đơn hàng</h2>

                            <div class="space-y-4">
                                <div class="flex justify-between items-center text-base">
                                    <span class="text-[#424752]">
                                        Tạm tính (<span id="item-count">${totalQuantity}</span> sản
                                        phẩm)
                                    </span>
                            ...
                            <div
                                class="pt-4 flex items-center gap-2 justify-center text-[#424752] text-xs opacity-60">
    ...
    <script>
                            ...
                            // Cập nhật lại số tiền và số lượng trên giao diện
                            ...
                            // Cập nhật số lượng tăng giảm bằng AJAX
                            ...
                            function removeItem(cartItemID) {
                                openConfirmModal('Xóa sản phẩm', 'Bạn có chắc muốn xóa sản phẩm này khỏi giỏ hàng?', function () {
                                    fetch(CART_URL, {
                                        method: 'POST',
                                        headers: {'Content-Type': 'application/x-www-form-urlencoded'},
