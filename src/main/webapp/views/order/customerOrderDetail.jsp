    ...
    <body class="bg-background text-on-surface min-h-screen">
        <aside class="hidden md:flex flex-col h-screen w-64 fixed left-0 top-0 bg-background-alt border-r border-outline-variant py-base gap-stack-sm z-40">
            ...
            <nav class="flex-1 space-y-1 mt-4">
                ...
                <a class="flex items-center px-4 py-3 mx-2 text-primary font-bold bg-surface-container-highest rounded-lg transition-all" href="${pageContext.request.contextPath}/dashboard/customer-order">
