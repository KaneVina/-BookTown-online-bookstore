                    ...
                    <body class="text-[#071e27] antialiased bg-[#f3faff]">
                                    ...
                                    <c:choose>
                                            ...
                                            <c:choose>
                                                <c:when
                                                    ...
                                                    <section
                                                        ...
                                                        <h2 class="text-lg font-bold text-[#071e27] mb-6">Trạng thái đơn
                                                            hàng &amp; Hoàn tiền</h2>
                                                        ...
                                                        <div class="relative flex justify-between items-start">
                                                            ...
                                                            <div
                                                                ...
                                                                <span class="text-xs font-bold text-[#004d99]">Đã đặt
                                                                    hàng</span>
                                                            ...
                                                            <div
                                                                ...
                                                                <span class="text-xs font-bold text-[#D32F2F]">Hủy
                                                                    đơn</span>
                                                            </div>
                                                     ...
                                                     ${refStep >= 4 ? 'bg-[#2E7D32] text-white' : (refStep == 3 ? 'bg-amber-50 text-amber-600 border-2 border-amber-500' : 'bg-gray-100 text-gray-400 border border-gray-200')}">
                                                                    <span class="material-symbols-outlined text-[22px]"
                                                                        ...
                                                                        <c:choose>
                                                                            <c:when test="${refStep >= 4}">check_circle
                                                                            </c:when>
                                                                ...
                                                                <span
                                                                    class="text-xs font-bold ${refStep == 3 ? 'text-amber-600' : (refStep >= 4 ? 'text-[#2E7D32]' : 'text-[#071e27]')}">
                                                                    Chờ hoàn tiền
                                                                </span>
                                                                <c:if test="${refStep == 3}">
                                                                    <span class="text-[10px] text-amber-500 mt-0.5">2–5
                                                                        ngày làm việc</span>
                                                                </c:if>
                                                            </div>
                                                     ...
                                                     ${refStep >= 4 ? 'bg-[#2E7D32] text-white' : 'bg-gray-100 text-gray-400 border border-gray-200'}">
                                                                    ...
                                                                    <span
                                                                        class="text-xs font-bold ${refStep >= 4 ? 'text-[#2E7D32]' : 'text-[#071e27]'}">
                                                                        Đã hoàn tiền
                                                                    </span>
                                                                    <c:if test="${refStep >= 4}">
                                                                        <span
                                                                            class="text-[10px] text-green-600 mt-0.5">Hoàn
                                                                            tất ✓</span>
                                                                    </c:if>
                                                                </div>
                                                        </div>
                                                                ...
                                                                <c:when
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            sẽ được hoàn vào tài khoản VNPAY của bạn
                                                                            trong vòng <strong>2–5 ngày làm
                                                                                việc</strong>.<br>
                                                                ...
                                                                <c:otherwise>
                                                                    <div
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            Vui lòng kiểm tra email xác nhận để biết
                                                                            thêm chi tiết.
                                                                        </div>
                                                                    </div>
                                                                </c:otherwise>
                                                ...
                                                <c:otherwise>
                                                    <section
                                                        ...
                                                        <div class="flex items-center gap-3">
                                                            ...
                                                            <p class="text-sm font-semibold text-red-700">Đơn hàng này
                                                                đã bị hủy.</p>
                                                        </div>
                                                        <c:if test="${not empty order.cancelReason}">
                                        ...
                                        <c:otherwise>
                                            <section class="bg-white p-6 rounded-xl border border-[#c2c6d4] shadow-sm">
                                                ...
                                                <div class="relative flex justify-between items-start">
                                                    ...
                                                    <div class="relative z-10 flex flex-col items-center text-center">
                                                        ...
                                                        <span class="text-xs font-bold text-[#004d99]">Đã
                                                            đặt hàng</span>
                                                        <span class="text-[11px] text-[#424752] mt-0.5">
                                                            <fmt:formatDate value="${order.createdAt}"
                                                                pattern="dd/MM/yyyy" />
                                            ...
                                            ${step > 3 ? 'bg-[#004d99] text-white' : (step == 3 ? 'bg-[#e6f6ff] text-[#004d99] border-2 border-[#004d99]' : 'bg-gray-100 text-gray-500 border border-gray-200')}">
                                                        ...
                                                        <span class="text-xs font-semibold text-[#071e27]">Đang
                                                            giao</span>
                                                    </div>
                                            ...
                                            ${step == 4 ? 'bg-[#004d99] text-white' : 'bg-gray-100 text-gray-500 border border-gray-200'}">
                                                        ...
                                                        <span class="text-xs font-semibold text-[#071e27]">Đã
                                                            nhận</span>
                                                    </div>
                                                </div>
                                            </section>
                                                ...
                                                <p class="text-[11px] text-[#424752] mt-0.5">
                                                    <c:choose>
                                                        <c:when test="${order.paymentStatus == 'paid'}">Đã
                                                            thanh toán</c:when>
                                                        <c:when test="${order.paymentStatus == 'pending_refund'}">
                                                            <span class="text-amber-600 font-semibold">Đang chờ hoàn
                                                                tiền</span>
                                                        </c:when>
                                                        <c:when test="${order.paymentStatus == 'refunded'}">
                                                            <span class="text-green-700 font-semibold">Đã hoàn
                                                                tiền</span>
                                                        </c:when>
                        ...
                        <script>
                            ...
                            function openCustomerCancelModal() {
                                ...
                                var errEl = document.getElementById('cancelModalError');
