...
<html lang="vi" class="light">
    ...
    <head>
        ...
        <title>Chi tiết đơn hàng ${order.orderCode} - BookTown</title>
        <link
            ...
            <div
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        <h1 class="text-2xl font-bold text-[#071e27]">Đơn hàng ${order.orderCode}</h1>
                        ...
                        <span class="px-3 py-1 font-bold text-xs rounded-full flex items-center
                            ...
                            <c:choose>
                                ...
                                <c:when test="${order.status == 'cancelled'}">Hủy đơn</c:when>
                ...
                <div class="lg:col-span-8 space-y-6">
                                ...
                                <c:when
                                    ...
                                    <section
                                        ...
                                        <h2 class="text-lg font-bold text-[#071e27] mb-6">
                                            Trạng thái đơn hàng &amp; Hoàn tiền</h2>
                                        ...
                                        <div class="relative flex justify-between items-start">
                                            ...
                                            <div
                                                ...
                                                <span
                                                    class="text-xs font-bold text-[#004d99]">Đã đặt hàng</span>
                                            ...
                                            <div
                                                ...
                                                <span
                                                    class="text-xs font-bold text-[#D32F2F]">Hủy đơn</span>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <span
                                                    class="text-xs font-bold ${refStep == 3 ? 'text-amber-600' : (refStep >= 4 ? 'text-[#2E7D32]' : 'text-[#071e27]')}">Chờ hoàn tiền</span>
                                                <c:if test="${refStep == 3}"><span
                                                        class="text-[10px] text-amber-500 mt-0.5">2–5 ngày làm việc</span></c:if>
                                                </div>
                                                ...
                                                <span
                                                    class="text-xs font-bold ${refStep >= 4 ? 'text-[#2E7D32]' : 'text-[#071e27]'}">Đã hoàn tiền</span>
                                                <c:if test="${refStep >= 4}"><span
                                                        class="text-[10px] text-green-600 mt-0.5">Hoàn tất</span></c:if>
                                                </div>
                                            </div>
                                                        ...
                                                        <div>
                                                            Số tiền <strong>
                                                                <fmt:formatNumber
                                                                    ...
                                                                    type="number"
                                                                    groupingUsed="true" /> đ
                                                            </strong> sẽ được hoàn vào tài khoản VNPAY của bạn trong vòng <strong>2–5 ngày làm việc</strong>.<br>
                                                        ...
                                                        <div>
                                                            Số tiền <strong>
                                                                <fmt:formatNumber
                                                                    ...
                                                                    type="number"
                                                                    groupingUsed="true" /> đ
                                                            </strong> đã được hoàn vào tài khoản của bạn.<br>
                            ...
                            <section
                                ...
                                <div class="relative flex justify-between items-start">
                                    ...
                                    <div
                                        ...
                                        <span class="text-xs font-bold text-[#071e27]">Xác nhận</span>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <span class="text-xs font-semibold text-[#071e27]">Đang giao</span>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <span class="text-xs font-semibold text-[#071e27]">Đã nhận</span>
                                    </div>
                                </div>
                            </section>
                        </c:otherwise>
                    ...
                    <section
                        ...
                        <div class="p-5 border-b border-[#c2c6d4] bg-[#F5F7F9]">
                            <h2 class="text-base font-bold text-[#071e27]">Sản phẩm trong đơn (${orderDetails.size()})</h2>
                        </div>
                    ...
                    <section class="bg-white p-5 rounded-xl border border-[#c2c6d4] shadow-sm">
                        ...
                        <div
                            ...
                            <div>
                                <p class="text-xs font-bold text-[#071e27]">
                                    <c:choose>
                                        <c:when test="${order.paymentMethod == 'cod'}">Thanh toán khi
                                            nhận hàng (COD)</c:when>
                                ...
                                <p class="text-[11px] text-[#424752] mt-0.5">
                                    <c:choose>
                                        <c:when test="${order.paymentStatus == 'paid'}">Đã thanh toán
                                        </c:when>
                                        
                                        <c:when test="${order.paymentStatus == 'pending_refund'}"><span
                                                class="text-amber-600 font-semibold">Đang chờ hoàn
                                                tiền</span></c:when>
                                        
                                        <c:when test="${order.paymentStatus == 'refunded'}"><span
                                                class="text-green-700 font-semibold">Đã hoàn tiền</span>
                                        </c:when>
                        ...
                        <div class="space-y-2.5 text-xs">
                            ...
                            <div
                                ...
                                <span class="text-sm font-bold text-[#071e27]">Tổng thanh toán</span>
